...
namespace AutoMode
{
    public partial class RecipeRenameForm : Form
    {
        private string m_strRecipeDirectory = "";
        #region properties
        public string ref_strRecipeRenameTo
        {
            get { return txt_RenameTo.Text; }
        }
        #endregion


        public RecipeRenameForm(string strEditRecipe, string strRecipeDirectory)
        {
            InitializeComponent();
            m_strRecipeDirectory = strRecipeDirectory;
            txt_RenameFrom.Text = strEditRecipe;
        }
        ...
        {
            string strNewRecipe = txt_RenameTo.Text;
