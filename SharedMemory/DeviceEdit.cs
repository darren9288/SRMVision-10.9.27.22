...
namespace SharedMemory
{
    public class DeviceEdit
    {
        ...
        private string m_strDeviceNo = "";
        private string m_strCurrentMonthDB = "";
        private OleDbDataAdapter m_daDeviceEditLog;
        private OleDbConnection m_DeviceEditLogConn;
        private string m_strHistoryDataLocation = "D:\\";
        public DataSet m_dsDeviceEditLog;
        private bool m_blnWantEditLog = true;
        #endregion


        public DeviceEdit(ProductionInfo smProductionInfo)
        {
        ...
        public void GetDeviceEditLogDataSet(string strDBFile)
        {
        ...
        public void SaveDeviceEditLog(string strModule, string strDescription, string strOriginalValue, string strNewValue, string strLotID)
        {
        ...
        public void SaveDeviceEditLogForImage(string strModule, string strDescription, string strOriginalValue, string strNewValue, string strCurrentDateTime, string strLotID)
        {
        ...
        public bool CopySettingFile(string originalFilePath, string originalFileName)
        {
        ...
        public void XMLChangesTracing(string strModule, string strLotID)
        {
        ...
        /// </summary>
        /// <param name="strDBFile">database file name (.mdb)</param>
        private void InitDeviceEditLogDataAdapter(string strDBFile)
        {
        ...
        private void SearchXMLAttribute(string strModule, XmlNode ExNode, XmlNode NewNode, string strLotID)
        {
