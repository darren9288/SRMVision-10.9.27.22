...
{
    public partial class LearnLeadPocketDontCareAreaFixForm : Form
    {
        ...
        public LearnLeadPocketDontCareAreaFixForm(VisionInfo visionInfo, CustomOption smCustomizeInfo, ProductionInfo smProductionInfo, string strSelectedRecipe, int intUserGroup)
        {
            InitializeComponent();
        ...
        private void DisableField2()
        {
            ...
            string strChild2 = "Learn Dont Care Area Fix";
        ...
        {
            chk_TopROI.Checked = (m_smVisionInfo.g_intLeadPocketDontCareROIFixMask & 0x01) > 0;
            chk_RightROI.Checked = (m_smVisionInfo.g_intLeadPocketDontCareROIFixMask & 0x02) > 0;
            chk_BottomROI.Checked = (m_smVisionInfo.g_intLeadPocketDontCareROIFixMask & 0x04) > 0;
            chk_LeftROI.Checked = (m_smVisionInfo.g_intLeadPocketDontCareROIFixMask & 0x08) > 0;
        }

        private void LearnLeadPocketDontCareAreaFixForm_Load(object sender, EventArgs e)
        {
        ...
        private void LearnLeadPocketDontCareAreaFixForm_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            SaveROISetting(strFolderPath + "Lead\\PocketDontCareROIFix.xml");
        ...
        private void SaveLeadSetting()
        {
            ...
            objFileHandle.WriteElement1Value("LeadPocketDontCareROIMaskFix", m_smVisionInfo.g_intLeadPocketDontCareROIFixMask);
        ...
        private void LoadLeadSetting()
        {
            ...
            m_smVisionInfo.g_intLeadPocketDontCareROIFixMask = objFileHandle.GetValueAsInt("LeadPocketDontCareROIMaskFix", 0, 1);
        ...
        private void SaveROISetting(string strFolderPath)
        {
            ...
            ROI objROI;
            for (int t = 0; t < m_smVisionInfo.g_arrLeadPocketDontCareROIsFix.Count; t++)
            {
                objFile.WriteSectionElement("Unit" + t, true);

                for (int j = 0; j < m_smVisionInfo.g_arrLeadPocketDontCareROIsFix[t].Count; j++)
                {
                    objROI = m_smVisionInfo.g_arrLeadPocketDontCareROIsFix[t][j];
        ...
        private void SetupSteps(bool blnForward)
        {
            ...
            switch (m_smVisionInfo.g_intLearnStepNo)
            {
                case 0: //Define Don't Care Area
                    AddPocketDontCareROI(m_smVisionInfo.g_arrLeadPocketDontCareROIsFix);
                    ...
                    for (int i = 1; i < m_smVisionInfo.g_arrLead.Length; i++)
                    {
                        ...
                        m_smVisionInfo.g_arrLeadPocketDontCareROIsFix[i][0].LoadROISetting(m_smVisionInfo.g_arrLeadPocketDontCareROIsFix[i][0].ref_ROIPositionX, m_smVisionInfo.g_arrLeadPocketDontCareROIsFix[i][0].ref_ROIPositionY,
                                                                                           m_smVisionInfo.g_arrLeadPocketDontCareROIsFix[i][0].ref_ROIWidth, m_smVisionInfo.g_arrLeadPocketDontCareROIsFix[i][0].ref_ROIHeight);
            ...
            switch (((CheckBox)sender).Name.ToString())
            {
                case "chk_TopROI":
                    if (((CheckBox)sender).Checked)
                        m_smVisionInfo.g_intLeadPocketDontCareROIFixMask |= 0x01;
                    else
                        m_smVisionInfo.g_intLeadPocketDontCareROIFixMask &= ~0x01;
                    break;
                case "chk_RightROI":
                    if (((CheckBox)sender).Checked)
                        m_smVisionInfo.g_intLeadPocketDontCareROIFixMask |= 0x02;
                    else
                        m_smVisionInfo.g_intLeadPocketDontCareROIFixMask &= ~0x02;
                    break;
                case "chk_BottomROI":
                    if (((CheckBox)sender).Checked)
                        m_smVisionInfo.g_intLeadPocketDontCareROIFixMask |= 0x04;
                    else
                        m_smVisionInfo.g_intLeadPocketDontCareROIFixMask &= ~0x04;
                    break;
                case "chk_LeftROI":
                    if (((CheckBox)sender).Checked)
                        m_smVisionInfo.g_intLeadPocketDontCareROIFixMask |= 0x08;
                    else
                        m_smVisionInfo.g_intLeadPocketDontCareROIFixMask &= ~0x08;
                    break;
            }
