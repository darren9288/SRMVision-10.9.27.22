...
namespace Common
{
    public class PdfPage
    {
        ...
        /// auto generate ID
        /// </summary>
        /// <returns>ID that haven't been used</returns>
    ...
    public class PdfWriter
    {
        ...
        /// Write
        /// </summary>
        /// <param name="strLines">content</param>
        /// <param name="strDestPath">destination to save the file</param>
        public void Write(string[] strLines, string strDestPath)
        {
            outFileStream = new FileStream(strDestPath, FileMode.Create, FileAccess.Write);
        ...
        private void DoText(string[] strLines)
        {
